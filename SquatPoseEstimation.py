...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            if knees_over_toes_right_side < 80 or knees_over_toes_left_side < 80:
                issues.append("push your knees outwards to align them with your feet")
                knee_outward_issues += 1
            if knees_over_toes_right_side > 115 or knees_over_toes_left_side > 115:
        ...
        if knee_outward_issues > 30 and not knee_outward_message_printed:
            ...
            knees_outward_message_printed = True
